System.register(['angular2/core', 'angular2/http', '../blocks/blocks', '../shared/shared'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            runnersUrl = '../api/runners.json';
            RunnerService = (function () {
                function RunnerService(_http, _exceptionService, _messageService, _spinnerService) {
                    var _this = this;
                    this._http = _http;
                    ...
                    this._messageService.state.subscribe(function (state) { return _this.getRunners(); });
                }
                RunnerService.prototype.addRunner = function (runner) {
                    var _this = this;
                    var body = JSON.stringify(runner);
                ...
                RunnerService.prototype.deleteRunner = function (runner) {
                    var _this = this;
                    this._spinnerService.show();
                    return this._http
                ...
                RunnerService.prototype.getRunners = function () {
                    var _this = this;
                    this._spinnerService.show();
                ...
                RunnerService.prototype.getRunner = function (id) {
                    return this.getRunners();
                };
                RunnerService.prototype.updateRunner = function (runner) {
                    var _this = this;
                    var body = JSON.stringify(runner);
                    this._spinnerService.show();
                    return this._http
